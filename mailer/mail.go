...
func (m *Mail) SendUsingAPI(msg Message, transport string) error {
	...
	default:
		err = errors.New("only mailgun, sparkpost, sendgrid and postmark supported")
	}
...
func (m *Mail) addAPIAttachments(msg Message, tm *apimail.Transmission) error {
